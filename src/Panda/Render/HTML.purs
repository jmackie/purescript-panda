          ...
          \update -> do
            foreachE (watcher update) \instruction -> do
              ...
              case indexAndSystem of
                ...
                _ -> Ref.write updatedSystems childSystems
            Ref.read childSystems
              >>= traverse_ \{ handleUpdate } ->
                  handleUpdate update
        }
      ...
      # Types.runHTMLDelegateX \(Types.HTMLDelegate { focus, application }) -> do
          ...
          pure
            ...
            , system:
              ...
              , handleUpdate:
                \{ state, input } -> case focus.input input of
                  Just subupdate -> system.update subupdate
                  Nothing -> pure unit
