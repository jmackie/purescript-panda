...
render element = case _ of
  Types.Fixed { key, value } -> renderStaticFixed element key value
  Types.Producer { key, onEvent } -> renderStaticProducer element key onEvent
  Types.Dynamic watcher -> renderDynamic element watcher
